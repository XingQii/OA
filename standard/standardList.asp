...
<%Dim rs
 set rs=Server.CreateObject("ADODB.Recordset")
  rs.open "select * from firmStandard where exist=1 ",conn,1,1
%>
...
%>
     <tr>
    <td><%=rs("standardNumber")%></td>
    <td><%=rs("standardName")%></td>
    <td>
    <a href="standardDetail.asp?standardId=<%=rs("id")%>">查看</a>
    <a href="reviseStandard.asp?standardId=<%=rs("id")%>">修改</a>
    </td>
    </tr>
    <%
		k=k+1
