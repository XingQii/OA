...
<%
  ...
  rs.open "select * from processProduct where exist=1",conn,1,1
...
%>
    ...
    <td>
    <a href="../sourceProcess/processDetail.asp?processId=<%=rs("id")%>">查看</a>
    <a href="../sourceProcess/reviseProcess.asp?processId=<%=rs("id")%>">修改</a>
    </td>
    </tr>
    <%
		k=k+1
