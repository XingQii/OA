...
<%Dim rs
 set rs=Server.CreateObject("ADODB.Recordset")
  rs.open "select * from batchBaseName where exist=1 ",conn,1,1
%>
...
%>
    ...
    <td><%=rs("name")%></td>
    <td>
    <a href="batchDetail.asp?batchId=<%=rs("id")%>">查看</a>
    <a href="reviseBatch.asp?batchId=<%=rs("id")%>">修改</a>
    </td>
    </tr>
    <%
		k=k+1
