...
Dim rsStock
  ...
  If Not rsStock.Eof Then
    ...
    rsStock.update
  Else
    response.Write "<script>alert('要投入的产品在库存中没有记录！请入库后再进行相关操作！');history.back()</script>"
  End If
  ...
  <li><a href="#">投入品出库</a></li>
    ...
    <form action="?action=add" method="post">
      <ul class="forminfo">
        ...
        <li>
          <label for="name">投入品名称</label><input  type="text" name="name" id="name" required>
        </li>
        <li>
